...
if __name__ == '__main__':
    ...
    for week in total_weeks:
        ...
        result_files = [
            (tracking_results, 'tracking_results.csv', ['time', 's', 'a', 'dis', 'event', 'nflId', 'displayName', 'jerseyNumber', 'position', 'frameId', 'team',
            ...
            (play_results, 'play_results.csv', ['gameId', 'playId', 'offense_h_play', 'offense_h_presnap',
       ...
       'defense_v_presnap', 'defense_v_to_throw', 'defense_v_to_arrived',
       'defense_v_to_end', 'defense_a_play', 'defense_a_presnap',
       'defense_a_to_throw', 'defense_a_to_arrived', 'defense_a_to_end',
